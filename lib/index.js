...
function ticksToD(axis) {
  var recalculatePos = function () {
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              _context.next = 4;
              return this.layer.prepareRender().catch(function (e) {});

            case 4:
              _contentSize = (0, _slicedToArray3.default)(this.contentSize, 2), w = _contentSize[0], h = _contentSize[1];
    ...
    return function recalculatePos(_x, _x2) {
