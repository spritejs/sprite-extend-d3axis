...
var Axis = (_temp = _class2 = function (_Group) {
  ...
  (0, _createClass3.default)(Axis, [{
    ...
    value: function render(t, drawingContext) {
      ...
      var labels = this.children.filter(function (node) {
        return node.nodeType === 'label';
      });

      labels.forEach(function (label) {
        var _label$contentSize2 = (0, _slicedToArray3.default)(label.contentSize, 2),
            w = _label$contentSize2[0],
            h = _label$contentSize2[1];

        var _label$attr = label.attr('pos'),
            _label$attr2 = (0, _slicedToArray3.default)(_label$attr, 2),
            x = _label$attr2[0],
            y = _label$attr2[1];
      ...
      (0, _get3.default)(Axis.prototype.__proto__ || (0, _getPrototypeOf2.default)(Axis.prototype), 'render', this).call(this, t, drawingContext);
    }
  }, {
    key: 'cloneNode',
